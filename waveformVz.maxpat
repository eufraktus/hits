...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"offset" : [ -4.0, -3.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 13.0, 39.0, 219.0, 89.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 279.0, 98.0, 114.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 279.5, 128.0, 58.0, 23.0 ],
					"text" : "scroll $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 236.0, 43.0, 114.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.5, 73.0, 58.0, 23.0 ],
					"text" : "scroll $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 419.5, 182.0, 476.0, 218.0 ],
					"phasespect" : 1,
					"range" : [ 0.0, 1.0 ],
					"scroll" : 2,
					"sono" : 1,
					"sonolocolor" : [ 0.325490196078431, 0.011764705882353, 0.454901960784314, 1.0 ],
					"sonomedcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"sonomedlocolor" : [ 0.549019607843137, 0.023529411764706, 0.764705882352941, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.5, 54.0, 492.0, 92.0 ],
					"range" : [ 0.0, 1.0 ],
					"sono" : 1,
					"sonomonobgcolor" : [ 0.0, 0.0, 0.0, 1.0 ],
					"sonomonofgcolor" : [ 0.992156862745098, 0.117647058823529, 0.996078431372549, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 553.0, 428.5, 342.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 428.5, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 11.0, 159.0, 20.0 ],
					"text" : "Waveform Vizualizer",
					"textcolor" : [ 0.647058823529412, 0.027450980392157, 0.901960784313726, 1.0 ]
				}
...
,
					"patching_rect" : [ 176.0, 189.5, 58.0, 23.0 ],
...
,
					"patching_rect" : [ 156.0, 164.5, 110.0, 23.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 33.0, 228.5, 370.0, 330.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 164.5, 123.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 58.0, 167.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 86.0, 204.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "146765__thenudo__heart-beat.wav",
								"filename" : "146765__thenudo__heart-beat.wav",
								"filekind" : "audiofile",
								"id" : "u505001096",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 172.0, 11.0, 292.0, 25.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"timestretch" : [ 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 246.0, 108.0, 390.0, 108.0, 390.0, 48.0, 413.0, 48.0 ],
					"source" : [ "obj-16", 0 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "146765__thenudo__heart-beat.wav",
				"bootpath" : "~/Dropbox/Apps/HITS3/samples/human",
				"patcherrelativepath" : "./samples/human",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
